...
class UserActivity extends Model
{
    ...
    public static function actionLabels(): array
    {
        return [
            ...
            'sites.posts.created' => 'Site post created',
            'sites.posts.updated' => 'Site post updated',
            'sites.posts.deleted' => 'Site post deleted',
            'sites.posts.synced' => 'Site Instagram posts synced',
            'sites.menu.created' => 'Site menu item created',
            'sites.menu.updated' => 'Site menu item updated',
            'sites.menu.deleted' => 'Site menu item deleted',
